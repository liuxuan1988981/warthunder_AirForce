...
def main():
    ...
    with tf.compat.v1.Session() as sess:
        ...
        out_graph = tf.graph_util.convert_variables_to_constants(sess,sess.graph_def,['Placeholder','BiasAdd', 'BiasAdd_1', 'BiasAdd_2', 'concat_19', 'concat_20', 'concat_21'])  # "yolo/Conv_13/BiasAdd"
