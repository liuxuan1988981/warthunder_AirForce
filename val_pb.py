...
pre_boxes = sess.graph.get_tensor_by_name('concat_19:0')
pre_score = sess.graph.get_tensor_by_name('concat_20:0')  # 
pre_label = sess.graph.get_tensor_by_name('concat_21:0')  # 
